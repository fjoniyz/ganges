...
public class ChargingStationMessage implements Serializable, AnonymizedMessage {
  ...
  @JsonCreator
  public ChargingStationMessage(@JsonProperty("ae_session_id")UUID ae_session_id,
                                @JsonProperty("timestamp")String timestamp, @JsonProperty("building_type") String building_type,
                                ...
                                @JsonProperty("loading_potential")int loading_potential) {
